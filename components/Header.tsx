      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center space-x-2">
            <span className="font-display text-2xl sm:text-3xl font-bold text-gray-900">
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <Link
                  href="/contact"
                  className="block px-3 py-2 mt-2 text-center bg-primary-600 text-white rounded-full hover:bg-primary-700"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Devis gratuit
                </Link>
